...
const XConfig = {
  count: 200,
  // Balanced palette: mostly neutrals with subtle brand accents
  // White weighted twice to keep the look clean, with gentle violet/pink/blue
  colors: [0xffffff, 0xf3f4f6, 0xe9d5ff, 0xa78bfa, 0xec4899, 0xffffff, 0x93c5fd],
  ...
  followCursor: false // Disable cursor following
};
...
class Z extends InstancedMesh {
  ...
  update(deltaInfo: { delta: number }) {
    ...
    for (let idx = 0; idx < this.count; idx++) {
      ...
      if (idx === 0 && this.config.followCursor) this.light!.position.copy(U.position);
    }
